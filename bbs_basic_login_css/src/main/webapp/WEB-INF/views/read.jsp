...
.read_table tbody tr th:nth-child(3), .read_table tbody tr td:nth-child(4){
display: none;
}
.read_subject, .read_content, .read_author {
width: 96%;
outline: none;
