            ...
            <div class="write_form">
                <form action="update" method="get">
                    ...
                    <table class="write_table">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" name="title" class="bbs_subject" value="${dto.title}" placeholder="글 제목" maxlength="50"></td>
                            </tr>
                            <tr>
                                <td><textarea name="content" class="bbs_content" placeholder="글 내용" maxlength="2048">${dto.content}</textarea></td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="write_btn">
